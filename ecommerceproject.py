...
def login():
    ...
    for i in list_user_data:
        if i != '':
            ...
            if username == dict_data['username'] and password == dict_data['password']:
                user_login = True
                user_type = dict_data['user_type']
                break
...
def view_bill(buyer_name):
    ...
    for i in list_bill_data:
        if i != '':
            ...
            if dict_bill_data['Buyer'] == buyer_name:
                print("Product: ", dict_bill_data['Product'])
                print("Quantity: ", dict_bill_data['Quantity'])
                print("Total: ", dict_bill_data['Total'])
